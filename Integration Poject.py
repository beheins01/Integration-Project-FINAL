...
if answer.lower().strip() == "yes":
    ...
    if int(answer) < 18:
        ...
        if answer.lower().strip() == "no":
            ...
            if answer.lower().strip() == "woods":
                ...
                answer = input("What do you do? (leave him/save him)")
                ...
                if answer.lower().strip() == "leave him":
                    ...
                    answer = input("(left him/saving you)")

                    if answer.lower().strip() == "saving you":
                        print("Well, at least he died a hero.")
                        print("Adventurer you may have survived,")
                        print("the wrath of the people,")
                        print("but you could not call yourself a hero")
                        print("after not telling the truth.")
                        print("You give up being a hunter,")
                        print("and your tale ends here.")
                        print("GAME OVER!")

                    elif answer.lower().strip() == "left him":
                        print("HOW COULD YOU!")
                ...
                elif answer.lower().strip() == "save him":
                    ...
                    if answer.lower().strip() == "cut out":
                        ...
                        print("They now decide to")
                        print("put you over the fire.")
    ...
    elif int(answer) > 50 and int(answer) <= 80:
